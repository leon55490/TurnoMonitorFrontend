			...
			<div className={styles.card}>
				...
				<form onSubmit={manejarEnvio} className={styles.formulario} noValidate={false}>
					...
					<div className={styles.campo}>
						<label htmlFor="monitor_id" className={styles.etiqueta}>
							Monitor
						</label>
						<select
							id="monitor_id"
					...
					{/* Sede */}
					<div className={styles.campo}>
						<label htmlFor="sede_id" className={styles.etiqueta}>
							Sede
						</label>
						<select
							id="sede_id"
					...
					<div className={styles.campo}>
						<label htmlFor="room_id" className={styles.etiqueta}>
							Salón
						</label>
						<select
							id="room_id"
					...
					<div className={styles.fila}>
						<div className={styles.campo}>
							<label htmlFor="hora_inicio" className={styles.etiqueta}>
								Hora inicio
							</label>
							<input
								type="time"
						...
						<div className={styles.campo}>
							<label htmlFor="hora_fin" className={styles.etiqueta}>
								Hora fin
							</label>
							<input
								type="time"
